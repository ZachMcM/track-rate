  ...
  if (rating && !isLoading) {
    return (
      <div className='flex flex-col space-y-5 shrink-0'>
        <div className="flex">
          <div className="flex flex-col text-center dark:border-zinc-800 border-r border-zinc-200 px-6">
        ...
        {
          session &&
          <MusicReviewButton type={type} data={data} className="py-3 px-4 dark:bg-white dark:text-zinc-950 text-center rounded-md drop-shadow-md text-white bg-zinc-950 font-medium hover:opacity-80 duration-300"/>
        }
      </div>
    )
  } else {
