  ...
  if (rating && !isLoading) {
    return (
      <div className='flex flex-col space-y-5 shrink-0'>
        ...
        {
          session &&
          <MusicReviewButton type={type} data={data} className="py-3 px-4 text-center rounded-md drop-shadow-lg bg-sky-400 font-medium text-white hover:opacity-80 duration-300"/>
        }
      </div>
    )
  } else {
