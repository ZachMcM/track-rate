  ...
  return (
    <div id="#comments" className="flex flex-col w-full space-y-10">
          ...
          <div className="w-full flex flex-col">
            <div className="flex flex-col space-y-5">
              <div className="flex flex-col space-y-1 w-full">
                <textarea
                    className={`h-40 overflow-y-auto placeholder:text-zinc-500 drop-shadow-lg duration-300 border border-zinc-200 bg-white w-full rounded-lg p-4 outline-none ${
                      error
                        ? "ring-2 ring-red-500"
                        : "focus:ring-2 ring-sky-200"
                    }`}              
              ...
              <button
                className="flex items-center justify-center px-4 py-3.5 rounded-lg font-medium bg-sky-400 text-white hover:opacity-80 duration-300"
      ...
      </div>
      {
        ...
        <div className="flex flex-col bg-white rounded-lg border border-zinc-200 drop-shadow-lg">
          {
