  ...
  if (trackTarget) {
    return (
      <div className="z-40 fixed w-full h-full left-0 top-0 bottom-0 backdrop-blur-md flex justify-center items-center">
        <div
          ref={modalRef}
          className="flex flex-col space-y-8 p-10 w-full m-10 md:w-3/5 rounded-md border border-zinc-700 bg-zinc-950"
        >
            ...
            <div className="flex flex-col space-y-5 w-full">
              ...
              <div className="flex flex-col space-y-2">
                <input
                  ...
                  className={`placeholder:text-zinc-400 text-sm bg-transparent border border-zinc-700 rounded-md px-4 py-3 outline-none ring-zinc-700 ring-offset-2 ring-offset-zinc-950 ${titleError ? "border-red-500 focus:ring-0" : "border-zinc-700 focus:ring-2"}`}
                />
              ...
              <div className="flex flex-col space-y-2">
                <textarea
                  ...
                  className={`min-h-max overflow-y-auto placeholder:text-zinc-400 text-sm bg-transparent border rounded-md p-4 outline-none ring-zinc-700 ring-offset-2 ring-offset-zinc-950 ${contentError ? "border-red-500 focring-0" : "border-zinc-700 focus:ring-2"}`}
