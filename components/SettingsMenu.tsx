...
export default function SettingsMenu() {
  ...
  return (
    <div className="flex space-x-3 md:w-1/6 md:space-x-0 md:flex-col md:space-y-3 font medium text-sm">
      ...
      {/* Todo */}
      <Link className={`py-2 px-4 text-start duration-300 rounded-md ${pathname == "/settings/appearance" ? "bg-zinc-800" : "hover:underline"}`} href={`/settings/appearance`}>Appearance</Link>
    </div>
  )
}