...
export default function Toast({ toast, setToast }: { toast: boolean, setToast: Dispatch<SetStateAction<boolean>> }) {
  ...
  return (
    <div className={`${!toast ? "translate-y-full" : "!m-5 translate-y-0"} duration-300 bg-zinc-950 group fixed bottom-0 right-0 p-5 w-1/3 border border-zinc-800 rounded-md`}>
      <button
