...
export default function ProfileDropdown({
  ...
  return (
    <div ref={dropdownRef} className="absolute top-11 drop-shadow-md border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 right-0 rounded-lg">
      <div        
      ...
      <div className="border-b dark:border-zinc-800 border-zinc-200 font-normal text-sm flex flex-col dark:bg-zinc-950 bg-white">
        <Link
          href={`/profile/${userId}`}
      ...
      <div className="font-normal text-sm flex flex-col bg-white dark:bg-zinc-950 rounded-b-md">
        <button
          onClick={() => signOut()}
          className="flex space-x-2 items-center p-2 m-1 dark:hover:bg-zinc-800 hover:bg-zinc-100 duration-300 rounded-lg"
        >
