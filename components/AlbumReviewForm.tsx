  ...
  if (albumTarget) {
    return (
      <div className="z-40 fixed w-full p-5 h-full left-0 top-0 bottom-0 backdrop-blur-md flex justify-center items-center">
        <div
          ref={modalRef}
          className="flex flex-col space-y-5 z-30 lg:space-y-0 lg:flex-row lg:space-x-10 p-10 w-full md:w-5/6 lg:w-2/3 rounded-md border border-gray-700 bg-gray-950 max-h-full overflow-y-auto"
        >
          ...
          <div className="flex flex-col space-y-5 w-full">
            ...
            <div className="relative w-full text-xs md:text-sm">
              ...
              {dropdown && (
                <div className="max-h-40 z-50 overflow-y-auto absolute w-full top-14 border border-gray-700 rounded-md flex flex-col bg-gray-950">
            ...
            <button
              className="w-fit flex space-x-2 items-center text-sm self-end bg-white hover:opacity-80 duration-300 px-4 py-2 font-semibold rounded-md"
              onClick={() => saveReview()}
            >
              <p className="text-gray-950">Save</p>
              {
                loadingSave ?
                <svg aria-hidden="true" className="w-5 h-5 mr-2 text-gray-400 animate-spin fill-sky-400" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <TbCheck className="text-gray-950 text-lg" />
              }
            </button>
          </div>
        </div>
