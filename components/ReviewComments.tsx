...
import { FullComment, FullReview } from "@/app/apiTypes"
      ...
      </div>
      {
        ...
        <div className="w-full flex flex-col">
          <div className="flex flex-col space-y-5 w-3/4 md:w-1/2 self-end">
            ...
            <button
              className="flex space-x-2 items-center text-xs md:text-sm w-fit self-end px-4 py-3 rounded-md bg-white text-gray-950 hover:opacity-80 duration-300"
