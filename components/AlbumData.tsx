...
import { formatCompactNumber, getAccessToken, getAlbum, getRating } from "@/app/apiMethods"
...
export default function AlbumData({ id }: { id: string }) {
  ...
  if (album && !isLoading && rating && !ratingLoading) {
    return (
      <div className="flex items-center flex-col space-y-5 md:space-y-0 md:flex-row md:space-x-10">
        ...
        <div className="flex flex-col space-y-3">
          ...
          <div className="flex space-x-5 items-center">
            <a href={album.external_urls.spotify} className="flex items-center space-x-2 bg-white text-zinc-950 py-2 px-4 rounded-md hover:opacity-80 duration-300">
